...
output_memory_list = []
output_memory_columns = ["M", "peak_before_first_iteration", "peak_after_training", "runtime"]

memory_outfile = "memoryUsage_mouseSagittal_L3_iterM_runSeperately.csv"

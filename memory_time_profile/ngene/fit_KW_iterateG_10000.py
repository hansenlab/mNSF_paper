...
output_memory_list = []
output_memory_columns = ["ngene", "peak_before_first_iteration", "peak_after_training", "runtime"]

memory_outfile = "memoryUsage_mouseSagittal_iterG_runSeperately.csv"
...
for ksample in range(0,nsample):
	X=pd.read_csv(path.join(dir_data,'X_small_forMemTimeProfile.csv'))
	Y=pd.read_csv(path.join(dir_data,'Y_500spots_forMemTimeProfile.csv'))
	Y=Y.iloc[0:500,0:ngene]
...
output_memory_list.append(ngene)

...
Y2 = rng.negative_binomial(10,10/(Lambda_true+10))
...
pp.log1p(ad1)
ad1.write_h5ad(path.join("ggblocks_lr_1_distorted.h5ad"),compression="gzip")

DF = pd.DataFrame(Ftrue) 
DF.to_csv("ggblocks_lr_1_distorted_sample1.csv")
...
pp.log1p(ad2)
ad2.write_h5ad(path.join("ggblocks_lr_2_distorted.h5ad"),compression="gzip")
DF = pd.DataFrame(Ftrue) 
DF.to_csv("ggblocks_lr_1_distorted_sample2.csv")
...
fig.savefig(path.join("ggblocks_factors_sample1_distorted.png"),bbox_inches='tight')
...
fig.savefig(path.join("ggblocks_factors_sample2_distorted.png"),bbox_inches='tight')

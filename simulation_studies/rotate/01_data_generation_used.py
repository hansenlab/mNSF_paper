...
pp.log1p(ad1)
ad1.write_h5ad(path.join("ggblocks_lr_1.h5ad"),compression="gzip")

DF = pd.DataFrame(Ftrue) 
DF.to_csv("ggblocks_lr_1_sample1.csv")
...
pp.log1p(ad2)
ad2.write_h5ad(path.join("ggblocks_lr_2.h5ad"),compression="gzip")
DF = pd.DataFrame(Ftrue) 
DF.to_csv("ggblocks_lr_1_sample2.csv")
...
fig.savefig(path.join("ggblocks_factors_sample1_rotated.png"),bbox_inches='tight')
...
fig.savefig(path.join("ggblocks_factors_sample2_rotated.png"),bbox_inches='tight')

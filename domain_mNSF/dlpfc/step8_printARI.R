...
# set1
ARI_mNSF = readRDS("ARI_vec_sample1_5_9_predLayers_mnsf_ClusterWithinEachSample_mnsfrefined_svgs_scaleV2.rds")
ARI_spatialPCA = readRDS( paste0("ARI_vec_sample1_5_9_predLayers_mnsf_ClusterWithinEachSample_spatialPCA_refined_svgs_set",1,"_L10.rds"))
...
# set2-4
for( set in 2:4){
  ARI_mNSF = readRDS( paste0("ARI_vec_sample1_5_9_predLayers_mnsf_ClusterWithinEachSample_mnsfrefined_scaleV2_3samples_034induced_set",set,".rds"))
  ARI_spatialPCA = readRDS( paste0("ARI_vec_sample1_5_9_predLayers_mnsf_ClusterWithinEachSample_spatialPCA_refined_svgs_set",set,"_L10.rds"))
...
#######  make plot
pdf("ARI_domainPred_dlpfc_svgs_3samples_3sets.pdf", height = 2, width = 10)

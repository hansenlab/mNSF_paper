...
process_multiSample.save_object(list_fit, 'list_fit_nb_L12_010Induced.pkl') 



########################################################################
with open( 'list_fit_nb_L12_010Induced.pkl', 'rb') as inp:
...
Wdf.to_csv(path.join("loadings_spde_nb_szMean_12samples_L12_fullData_010Induced.csv"))
...
for k in range(0,nsample):
	...
	Factors_df.to_csv(path.join(dir_output,"factors_nb_szMean_sample_s"+str(k+1)+"_L12_fullData_010Induced.csv"))

...
for L in [4,8,12,16,20]:# finished running
	print(L)
	with open( 'list_fit_nb_L'+str(L)+'_010Induced.pkl', 'rb') as inp:
	...
	vec_dev_df.to_csv(path.join("vec_dev_500selectedFeatures_dev_interpolated_35percent_szMean_L"+str(L)+"_010Induced.csv"))

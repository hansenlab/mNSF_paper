...
list_fit=process_multiSample.ini_multiSample(list_D,L,"nb",disp=1)
...
process_multiSample.save_object(list_fit, 'list_fit_nb_12samples_szMean_L10_fullData_disp1.pkl') 



########################################################################
with open( 'list_fit_nb_12samples_szMean_L10_fullData_disp1.pkl', 'rb') as inp:
...
Wdf.to_csv(path.join("loadings_spde_nb_szMean_12samples_L10_fullData_disp1.csv"))
...
for k in range(0,nsample):
	...
	Factors_df.to_csv(path.join(dir_output,"factors_nb_szMean_sample_s"+str(k+1)+"_L10_fullData_disp1.csv"))

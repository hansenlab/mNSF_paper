...
list_fit = process_multiSample.ini_multiSample(list_D,L,lik="nb",disp=100)
...
process_multiSample.save_object(list_fit, 'list_fit_500selectedFeatures_dev_interpolated_35percent_szMean_disp100.pkl') 


with open('list_fit_500selectedFeatures_dev_interpolated_35percent_szMean_disp100.pkl', 'rb') as inp:
...
Wdf.to_csv(path.join("loadings_spde_L20_500selectedFeatures_dev_interpolated_35percent_szMean_disp100.csv"))
...
for k in range(0,nsample):
	...
	Factors_df.to_csv(path.join("factors_sample"+str(k+1)+"_500selectedFeatures_dev_interpolated_35percent_szMean_disp100.csv"))
